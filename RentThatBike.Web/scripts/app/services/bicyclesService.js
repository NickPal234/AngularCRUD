(function () {
    ...
    myAppModule.factory('bicyclesService', function () {
        ...
        var bicycles = [
                    { id: 1, name: "Fast bike", type: 1, typeName: "Road Bike", quantity: 5, rentPrice: 15 },
                    { id: 2, name: "bike", type: 2, typeName: "Mountain Bike", quantity: 20, rentPrice: 17 },
                    { id: 3, name: "Classic", type: 3, typeName: "Urban Bike", quantity: 20, rentPrice: 14 },
                    { id: 4, name: "bike", type: 4, typeName: "Children Bike", quantity: 20, rentPrice: 9 }
        ];
